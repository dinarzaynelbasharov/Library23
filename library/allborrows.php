<html>
	...
	?>		
		...
		$result = pg_query($db, "SELECT * FROM see_allborrows() AS (bname varchar(100), rname varchar(100), borrowdate date, returndate date, status boolean);")or die(pg_last_error($db));	
		$a=pg_fetch_array($result);
		echo "<table class=table>";
		echo "<tr><th><b>Название книги</b></th><th><b>ФИО читателя</b></th><th><b>Дата выдачи</b></th><th><b>Дата возврата</b></th><th><b>Статус</b></th><tr>";
		do
		{
			$pole1=$a[0];
			$pole2=$a[1];
