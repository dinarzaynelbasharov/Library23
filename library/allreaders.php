<html>
	...
	?>		
		...
		$result = pg_query($db, "SELECT * FROM see_readers() AS (id integer, login varchar(20), name varchar(100), phonenumber varchar(11), email varchar(100), dateofbirth date);")or die(pg_last_error($db));	
